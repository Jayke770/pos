...
export const Categories = model("categories", CategorySchame, "categories", {
...
export const Products = model("products", ProductSchema, "products", {
  overwriteModels: true,
});
...
export const Dashboard = model("dashboard", DashboardSchema, "dashboard", {
  overwriteModels: true,
});
