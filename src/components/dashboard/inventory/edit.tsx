...
const itemTypes = [
    ...
    { id: "food", name: "Food Item", description: "Ready-to-serve food products" },
    { id: "packaging", name: "Packaging", description: "Cups, lids, bags, etc." },
    { id: "supply", name: "Supply", description: "General supplies and equipment" },
]
...
export function EditInventoryDialog({ item, open, onOpenChange, onUpdateItem }: EditInventoryDialogProps) {
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="e.g. Coffee Beans - Arabica" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                                    ...
                                    <CardContent className="p-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="font-medium">{watchedValues.name || "Item Name"}</h4>
                                                <p className="text-sm text-muted-foreground">
                                                    {watchedValues.type ? getTypeName(watchedValues.type) : "No type selected"}
                                                </p>
                                                {watchedValues.description && (
                                                    <p className="text-xs text-muted-foreground mt-1">{watchedValues.description}</p>
                                                )}
                                            </div>
                                            <div className="text-right">
                                                <div className="text-lg font-bold">
                                                    {watchedValues.currentStock || 0}/{watchedValues.maxStock || 0}{" "}
                                                    {watchedValues.unit || "units"}
                                                </div>
                                                <Badge
                                                    variant="secondary"
                                                    className={
                                                        getStockStatus(watchedValues.currentStock || 0, watchedValues.lowStockThreshold || 0) ===
                                                            "out"
