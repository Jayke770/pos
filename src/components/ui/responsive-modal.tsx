...
>(({ side = "bottom", className, children, ...props }, ref) => (
	<ResponsiveModalPortal>
		...
		>
			{children}
			<ResponsiveModalClose className="absolute right-4 top-4 rounded-sm ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none">
				<X className="h-4 w-4" />
