...
export function SalesSection() {
  ...
  const itemCountByProduct = allOrders.flatMap(order => 
          ...
          <div>
            <TabsList>
              <TabsTrigger 
                ...
                className={period === 'day' ? 'data-[selected=true]:bg-primary data-[selected=true]:text-primary-foreground' : ''}
              >
                Day
              </TabsTrigger>
              <TabsTrigger 
                ...
                className={period === 'week' ? 'data-[selected=true]:bg-primary data-[selected=true]:text-primary-foreground' : ''}
              >
                Week
              </TabsTrigger>
              <TabsTrigger 
                ...
                className={period === 'month' ? 'data-[selected=true]:bg-primary data-[selected=true]:text-primary-foreground' : ''}
              >
                Month
              </TabsTrigger>
            </TabsList>
