import { Category, Product, Order, DailySales } from '@/lib/types';
    ...
    customizations: [
      {
        ...
        options: [
          ...
          { id: 'feta', name: 'Feta Cheese', price: 1.00 },
        ],
      },
    ],
  },
...
export const salesData: DailySales[] = [
  ...
  { date: '2025-05-02', total: 1345.50, orders: 195 },
  { date: '2025-05-03', total: 1575.25, orders: 210 },
  { date: '2025-05-04', total: 1190.00, orders: 165 },
  { date: '2025-05-05', total: 1320.50, orders: 184 },
